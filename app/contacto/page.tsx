        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16">
            ...
            <div className="hidden sm:flex lg:hidden items-center justify-center flex-1 space-x-4">
              ...
              <Link href="/contacto" className="bangers-regular text-base text-orange-500 border-b-2 border-orange-500 transition-colors">
                {t('nav.contact')}
              </Link>
              {user && (
            ...
            <div className="hidden lg:flex items-center justify-center flex-1 space-x-6">
              ...
              <Link href="/contacto" className="bangers-regular text-lg xl:text-xl text-orange-500 border-b-2 border-orange-500 transition-colors">
                {t('nav.contact')}
              </Link>
              {user && (
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-md mx-auto">
            <a 
              href="https://share.google/aStYMIZNSiz6Qvvr1"
              target="_blank"
              rel="noopener noreferrer"
