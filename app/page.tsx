    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center pt-12 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="bangers-regular text-5xl md:text-7xl text-white mb-6 drop-shadow-lg" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>
            {t('hero.title').split('\n').map((line, index) => (
              <span key={index}>
                {line}
          ...
          <Link href="/alquiler">
              <Button size="lg" className="bangers-regular bg-orange-500 hover:bg-orange-600 text-white text-2xl md:text-3xl px-10 py-5 drop-shadow-lg shadow-lg" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)', boxShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>
                {t('hero.cta')}
              </Button>
            </Link>
        </div>
        ...
        {showMobileBadge && (
          <a 
            href="https://share.google/TFHA1frnpErV8QTQn"
            target="_blank"
            rel="noopener noreferrer"
            className="absolute bottom-[1.25rem] md:bottom-4 left-1/2 transform -translate-x-1/2 md:left-14 md:transform-none bg-white hover:bg-gray-50 text-gray-800 px-3 py-2 rounded-lg shadow-lg transition-all duration-300 hover:scale-105 flex items-center space-x-2 border border-orange-500"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-white/20 border-white/30 h-80">
              <CardContent className="p-6 text-center h-full flex flex-col justify-center">
                ...
                <h3 className="bangers-regular text-2xl md:text-3xl text-white mb-2 drop-shadow-lg" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>{t('services.step1.title')}</h3>
                <h4 className="bangers-regular text-xl md:text-2xl text-white mb-2 drop-shadow-lg" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>{t('services.step1.subtitle')}</h4>
            ...
            <Card className="bg-white/20 border-white/30 h-80">
              <CardContent className="p-6 text-center h-full flex flex-col justify-center">
                ...
                <h3 className="bangers-regular text-2xl md:text-3xl text-white mb-2 drop-shadow-lg" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>{t('services.step2.title')}</h3>
                <h4 className="bangers-regular text-xl md:text-2xl text-white mb-2 drop-shadow-lg" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>{t('services.step2.subtitle')}</h4>
                <p className="text-white/90 text-sm">
            ...
            <Card className="bg-white/20 border-white/30 h-80">
              <CardContent className="p-6 text-center h-full flex flex-col justify-center">
                ...
                <h3 className="bangers-regular text-2xl md:text-3xl text-white mb-2 drop-shadow-lg" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>{t('services.step3.title')}</h3>
                <h4 className="bangers-regular text-xl md:text-2xl text-white mb-2 drop-shadow-lg" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8)'}}>{t('services.step3.subtitle')}</h4>
                <p className="text-white/90 text-sm">
                ...
                <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                  {/* Visa */}
                   <div className="bg-white rounded-lg p-1 shadow-lg border border-gray-200 w-12 h-8 flex items-center justify-center">
                     <svg viewBox="0 0 48 32" className="w-10 h-6">
                       ...
                       <text x="24" y="20" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold" fontFamily="Arial, sans-serif" fontStyle="italic">VISA</text>
                     </svg>
                   </div>
                  ...
                  <div className="bg-white rounded-lg p-1 shadow-lg border border-gray-200 w-12 h-8 flex items-center justify-center">
                    <svg viewBox="0 0 48 32" className="w-10 h-6">
                      ...
                      <path d="M24 10c-1.8 1.4-2.9 3.5-2.9 6s1.1 4.6 2.9 6c1.8-1.4 2.9-3.5 2.9-6S25.8 11.4 24 10z" fill="#FF5F00"/>
                    </svg>
                  </div>
                  ...
                  {/* American Express */}
                   <div className="bg-white rounded-lg p-1 shadow-lg border border-gray-200 w-12 h-8 flex items-center justify-center">
                     <svg viewBox="0 0 48 32" className="w-10 h-6">
                       ...
                       <text x="24" y="20" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold" fontFamily="Arial, sans-serif" fontStyle="italic">AMEX</text>
                     </svg>
                   </div>
                  ...
                  <div className="bg-white rounded-lg p-1 shadow-lg border border-gray-200 w-12 h-8 flex items-center justify-center">
                    <svg viewBox="0 0 48 32" className="w-10 h-6">
                      <rect width="48" height="32" fill="white"/>
                      <circle cx="16" cy="16" r="10" fill="none" stroke="#0079BE" strokeWidth="1.5"/>
                      <circle cx="32" cy="16" r="10" fill="none" stroke="#0079BE" strokeWidth="1.5"/>
                      <text x="24" y="19" textAnchor="middle" fill="#0079BE" fontSize="7" fontWeight="bold">DC</text>
                    </svg>
                  </div>
                  ...
                  <div className="bg-white rounded-lg p-1 shadow-lg border border-gray-200 w-12 h-8 flex items-center justify-center">
                    <svg viewBox="0 0 48 32" className="w-10 h-6">
                      <rect width="48" height="32" fill="#F7931A"/>
                      <text x="24" y="20" textAnchor="middle" fill="white" fontSize="12" fontWeight="bold" fontFamily="Arial, sans-serif">₿</text>
                    </svg>
                  </div>
                </div>
              </div>
