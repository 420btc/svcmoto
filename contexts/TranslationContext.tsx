...
const translations = {
  es: {
    ...
    // Service Items
    'serviceItem.batteryChange.name': 'Intercambio Baterías',
    'serviceItem.batteryChange.description': 'Nunca te preocupes por quedarte sin energía. Nuestras estaciones de intercambio de baterías 24/7 en Málaga, Torremolinos, Benalmádena y Fuengirola aseguran que siempre estés listo para continuar. Sigue explorando sin interrupciones con total tranquilidad. Mas información en tienda física.',
    'serviceItem.batteryChange.price': 'Gratis',
    'serviceItem.batteryChange.time': '24/7',
    'serviceItem.batteryChange.include1': 'Estaciones disponibles 24/7',
    'serviceItem.batteryChange.include2': 'Cobertura en toda la Costa del Sol',
    'serviceItem.batteryChange.include3': 'Intercambio instantáneo',
    'serviceItem.batteryChange.include4': 'Sin tiempo de espera',
    'serviceItem.batteryChange.include5': 'Servicio completamente gratuito',
    'serviceItem.pickupDelivery.name': 'Recogida y Entrega',
    'serviceItem.pickupDelivery.description': 'Disfruta de la máxima comodidad con nuestro servicio de recogida y entrega a domicilio. Recogemos tu vehículo eléctrico directamente en tu ubicación y te lo devolvemos completamente revisado y listo para usar. Perfecto para tu rutina diaria sin interrupciones. Pídelo ahora!',
    'serviceItem.pickupDelivery.price': '5€',
    ...
    'serviceItem.expressService.description': 'Cuando el tiempo es crucial, nuestro servicio exprés está aquí para ti. Reparaciones urgentes completadas en menos de 2 horas con técnicos especializados disponibles las 24 horas. Ideal para emergencias y situaciones que requieren atención inmediata y profesional.',
  ...
  en: {
    ...
    // Service Items
    'serviceItem.batteryChange.name': 'Battery Swaps',
    'serviceItem.batteryChange.description': 'Never worry about running out of power. Our 24/7 battery swap stations across Málaga, Torremolinos, Benalmádena, and Fuengirola ensure you\'re always ready to go. Keep exploring without interruption with complete peace of mind.',
    'serviceItem.batteryChange.price': 'Free',
    'serviceItem.batteryChange.time': '24/7',
    'serviceItem.batteryChange.include1': '24/7 available stations',
    'serviceItem.batteryChange.include2': 'Costa del Sol coverage',
    'serviceItem.batteryChange.include3': 'Instant swap',
    'serviceItem.batteryChange.include4': 'No waiting time',
    'serviceItem.batteryChange.include5': 'Completely free service',
    'serviceItem.pickupDelivery.name': 'Pickup and Delivery',
    'serviceItem.pickupDelivery.description': 'Enjoy maximum convenience with our home pickup and delivery service. We collect your electric vehicle directly from your location and return it completely serviced and ready to use. Perfect for your daily routine without any interruptions.',
    'serviceItem.pickupDelivery.price': '5€',
    ...
    'serviceItem.expressService.description': 'When time is crucial, our express service is here for you. Urgent repairs completed in less than 2 hours with specialized technicians available 24/7. Ideal for emergencies and situations requiring immediate and professional attention.',
